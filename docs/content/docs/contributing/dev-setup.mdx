...
7. `npm rebuild` — rebuilds `@opentabs-dev/cli`, `@opentabs-dev/plugin-tools`, and `@opentabs-dev/create-plugin` to link their bin scripts after TypeScript compilation
