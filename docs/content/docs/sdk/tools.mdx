...
<Table>
  ...
  <Table.Body>
    ...
    <Table.Row>
      <Table.Cell className="font-medium">`summary`</Table.Cell>
      <Table.Cell>`string`</Table.Cell>
      <Table.Cell>Short human-readable summary for the UI. Falls back to `description` if omitted. Useful when the full description is too verbose for compact UI layouts.</Table.Cell>
    </Table.Row>
    <Table.Row>
