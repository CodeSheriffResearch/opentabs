...
const buttonVariants = cva(
  'font-head rounded transition-all outline-hidden cursor-pointer duration-200 font-medium flex justify-center items-center disabled:opacity-60 disabled:cursor-not-allowed',
  {
    variants: {
      variant: {
        default:
