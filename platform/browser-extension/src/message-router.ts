...
const methodHandlers = new Map<string, MessageHandler>([
  ...
  ['browser.getSecurityInfo', wrapAsync('browser.getSecurityInfo', handleBrowserGetSecurityInfo)],
  ['browser.getMemoryUsage', wrapAsync('browser.getMemoryUsage', handleBrowserGetMemoryUsage)],
